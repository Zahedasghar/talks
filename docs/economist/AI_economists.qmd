...
## Descriptive AI vs. Generative AI {.scrollable}
...
------------------------------------------------------------------------
## Descriptive AI vs. Generative AI (Comparison){.scrollable}

| Feature               | **Descriptive AI**                                     | **Generative AI**                                  |
|-----------------------|--------------------------------------------------------|----------------------------------------------------|
...
- **Descriptive AI** analyzes existing data to provide insights, while **Generative AI** creates something entirely new. 
...
## Things to be discussed discussed {.scrollable}

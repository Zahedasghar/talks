---
title: "Prompting"
author: "[**Zahid Asghar, QAU**]{.yellow}"

format: 
  docx:
    footer: "[Zahid Asghar](https://zahidasghar.com)&nbsp;&nbsp;&nbsp;"
    logo: "images/pips.png"
    theme: [default, custom1.scss]
    css: style.scss
    chalkboard: true
    slide-number: c/t
    title-slide-attributes:
      data-background-image: images/pips1.png
      data-background-size: 70% # Make the image smaller
      data-background-opacity: 40% # Make the image lighter
date: "2024-11-20"
execute:
  echo: false
  warning: false
...
### Document Drafting
- "Create a professional business proposal template."
- "Generate a summary of this 10-page report."
- "Format this document to APA style."

### Editing and Proofreading
- "Check this document for grammar and spelling errors."
- "Rewrite this paragraph to make it more concise."
- "Suggest improvements for the introduction section."

### Content Generation
- "Write a cover letter for a marketing manager position."
- "Create an outline for a research paper on climate change."
- "Generate a list of interview questions for a software developer role."

## Microsoft PowerPoint (PPTX)

### Presentation Creation
- "Create a 10-slide presentation on the benefits of renewable energy."
- "Generate a pitch deck for a startup in the tech industry."
- "Design a training presentation on workplace safety."

### Design and Layout
- "Suggest a modern design theme for this presentation."
- "Add relevant images and icons to these slides."
- "Create a visually appealing title slide."

### Content Enhancement
- "Summarize this report into key points for a presentation."
- "Add speaker notes for each slide."
- "Create an infographic to represent this data."

## Microsoft Excel

### Data Analysis
- "Analyze this sales data and generate insights."
- "Create a pivot table to summarize this dataset."
- "Generate a forecast for the next quarter based on this data."

### Formulas and Functions
- "Write a formula to calculate the average sales per month."
- "Use VLOOKUP to find the corresponding values from another sheet."
- "Create a conditional formatting rule to highlight cells above a certain value."

### Visualization
- "Create a bar chart to represent this data."
- "Generate a dashboard to track key performance indicators."
- "Create a scatter plot to show the relationship between these variables."

These prompts should help you leverage the capabilities of Microsoft Office tools to enhance your productivity and create high-quality documents, presentations, and spreadsheets. If you need more specific prompts or have a particular task in mind, feel free to let me know!

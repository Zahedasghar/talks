...
format: 
  revealjs:
    ...
    title-slide-attributes:
      ...
      data-background-size: 60% # Make the image smaller
...
# {background-image=images/pips1.png}
::: {.absolute left="75%" top="45%" style="font-size:1.1em; padding: 0.5em 1em; background-color: rgba(255, 255, 250, 0.5); backdrop-filter: blur(2px); box-shadow: 0 0 1.5rem 0 rgba(0, 0, 0, .5); border-radius: 5px;"}

Emerging Trends in Office Work - Use of AI 
:::

# {background-image=https://tettra.com/wp-content/uploads/2023/10/use-AI-at-work.jpg}

::: {.absolute left="75%" top="45%" style="font-size:1.1em; padding: 0.5em 1em; background-color: rgba(255, 255, 250, 0.5); backdrop-filter: blur(2px); box-shadow: 0 0 1.5rem 0 rgba(0, 0, 0, .5); border-radius: 5px;"}

[Always embrace the unexpected]{.red}
...
## Leading LLMs (as of 10/10/2024){.scrollable}
...
### [**“Graduating students who can write only as well as AI seems like a recipe for unemployment.”**]{.yellow}
...
- **YouTube:** [https://www.youtube.com/c/ZahidAsghar](https://www.youtube.com/c/ZahidAsghar)
